...
namespace RoboWeb
{
    public partial class _Default : Page
    {
        ...
        protected void checkELevementeContraido_CheckedChanged(object sender, EventArgs e)
        {

        }

        protected void checkEContraido_CheckedChanged(object sender, EventArgs e)
        {

        }

        protected void checkEFortementeContraido_CheckedChanged(object sender, EventArgs e)
        {
        ...
        protected void checkDLevementeContraido_CheckedChanged(object sender, EventArgs e)
        {

        }

        protected void checkDContraido_CheckedChanged(object sender, EventArgs e)
        {

        }

        protected void checkDFortementeContraido_CheckedChanged(object sender, EventArgs e)
        {
